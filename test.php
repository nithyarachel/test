<?php
    ...
    $_M['admin_sync_updated_duedate'] = 'Due date updated from admin area. Due date:%s';
    ...
    $_M['client_step_one'] = 'Client visited 1th configuration page. Certificate type:%s';
    $_M['client_step_two'] = 'Client visited 2th configuration page. Certificate type:%s, domain:%s';
    $_M['client_step_three_remote_id_selected_from_account'] = '3th configuration page: Certificate type:%s, remoted id %s has been recieved from NC account (used tokens)';
    $_M['client_step_three_remote_id_created'] = '3rd configuration page: Certificate type:%s, certificate has been created in NC account by module. Remote id:%s';
    
    $_M['client_step_three_activated'] = '3rd configuration page: certificate has been activated. Certificate type:%s, remote id:%s, approver email:%s, admin email:%s';
    $_M['client_step_three_activated_http_based_validation'] = '3rd configuration page: certificate has been activated. Certificate type:%s, remote id:%s, http-based validation, admin email:%s';
